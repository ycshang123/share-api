...
import com.ycshang.contentservice.service.RedisService;
...
public class AuthAspect {
    ...
    @Around("@annotation(com.ycshang.contentservice.auth.CheckLogin)")
...
//     3、如果校验成功，将永不信息设置到request的attribute里面
    ...
    @Around("@annotation(com.ycshang.contentservice.auth.CheckAuthorization)")
